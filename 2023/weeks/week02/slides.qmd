...
Review this image. How do you describe the two correction types?  
![Alt Text](figures/W2_RTC.gif)
...
SAR uses an antenna) that is moving as it emits signals and receives the echos
